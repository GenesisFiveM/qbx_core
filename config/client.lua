return {
    ...
    pauseMapText = 'Genesis',     -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        appId = '1046359865016193034', -- This is the Application ID (Replace this with you own)
        ...
        largeIcon = {                  -- To set this up, visit https://forum.cfx.re/t/how-to-updated-discord-rich-presence-custom-image/157686
            ...
            text = 'Genesis Roleplay', -- Here you can add hover text for the 'large' icon.
        },
        ...
        firstButton = {
            text = 'Discord!',
            link = 'https://discord.gg/genesisfivem',
        },
        secondButton = false
    },
